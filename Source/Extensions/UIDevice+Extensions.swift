...
public extension UIDevice {
    ...
    var is4sOrIpad: Bool {
        return UIDevice.current.modelName == "iPad 2" ||
            UIDevice.current.modelName == "iPad 3" ||
            UIDevice.current.modelName == "iPad 4" ||
            UIDevice.current.modelName == "iPad Air" ||
            UIDevice.current.modelName == "iPad Air2" ||
            UIDevice.current.modelName == "iPad Mini 2" ||
            UIDevice.current.modelName == "iPad Mini 3" ||
            UIDevice.current.modelName == "iPad Mini 3" ||
            UIDevice.current.modelName == "iPad Pro" ||
            UIDevice.current.modelName == "iPhone 4s"
    }
    
    var isEligibleForLatencyMeasurement: Bool {
        switch modelName {
        case "iPhone 4s",
             "iPhone 5",
             "iPhone 5c",
